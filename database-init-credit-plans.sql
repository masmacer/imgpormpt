...
('free-plan', 'Free Plan', 3, 90, 'Free tier with daily limits', datetime('now'), datetime('now')),
('pro-plan', 'Pro Plan', 0, 1000, 'Professional tier with unlimited daily usage', datetime('now'), datetime('now')),
